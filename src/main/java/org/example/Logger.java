...
public class Logger {
    ...
    protected static void logSubmissionsPerSecond(long startTime, int submissionsCount, int totalTasks) {
        ...
        System.out.print("\rElapsed time: " + elapsedTime + "ms | Submissions per second: " +  String.format("%.2f", submissionsPerSecond)  + " | " + submissionsCount + "/" + totalTasks);
    }
    ...
    protected static void logCompletionsPerSecond(long startTime, int completedCount, int totalTasks) {
        ...
        System.out.print("\rElapsed time: " + elapsedTime + "ms | Completions per second: " + String.format("%.2f", completionsPerSecond)  + " | " + completedCount + "/" + totalTasks);
    }
